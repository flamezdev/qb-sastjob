local Translations = {
    error = {
        ...
        on_duty_statetrooper_only = 'For on-duty troopers only',
    ...
    info = {
        ...
        blip_text = 'statetrooper Alert - %{text}',
    ...
    menu = {
        garage_title = 'State Trooper Vehicles',
        close = '⬅ Close Menu',
        impound = 'Impounded Vehicles',
        pol_impound = 'State Trooper Impound',
        pol_garage = 'State Trooper Garage',
        pol_armory = 'State Trooper Armory',
    },
    email = {
        sender = 'Central Judicial Collection Agency',
        subject = 'Debt collection',
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the statetrooper.<br />There is <strong>$%{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Place Spike Strip (statetrooper Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (statetrooper Only)',
        cuff_player = 'Cuff Player (statetrooper Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (statetrooper Only)',
        jail_player = 'Jail Player (statetrooper Only)',
        unjail_player = 'Unjail Player (statetrooper Only)',
        clearblood = 'Clear The Area of Blood (statetrooper Only)',
        seizecash = 'Seize Cash (statetrooper Only)',
        softcuff = 'Soft Cuff (statetrooper Only)',
        camera = 'View Security Camera (statetrooper Only)',
        flagplate = 'Flag A Plate (statetrooper Only)',
        unflagplate = 'Unflag A Plate (statetrooper Only)',
        plateinfo = 'Run A Plate (statetrooper Only)',
        depot = 'Impound With Price (statetrooper Only)',
        impound = 'Impound A Vehicle (statetrooper Only)',
        paytow = 'Pay Tow Driver (statetrooper Only)',
        paylawyer = 'Pay Lawyer (statetrooper, Judge Only)',
        anklet = 'Attach Tracking Anklet (statetrooper Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (statetrooper Only)',
        drivinglicense = 'Seize Drivers License (statetrooper Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (statetrooper Only)',
        statetrooper_report = 'State Trooper Report',
