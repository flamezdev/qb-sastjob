local Translations = {
    error = {
        ...
        on_duty_statetrooper_only = 'Reservé aux policiers en service.',
    ...
    info = {
        ...
        bill = 'Amender',
        amount = 'Montant',
        statetrooper_plate = 'SAST', --Should only be 4 characters long
    ...
    menu = {
        garage_title = 'Véhicule de statetrooper',
        close = '⬅ Fermer le menu',
        impound = 'Fourrière',
        pol_impound = 'Fourrière de statetrooper',
        pol_garage = 'Garage de statetrooper',
        pol_armory = 'Armurerie',
    },
    email = {
        sender = 'Agence Centrale de Collection Judiciare',
        subject = 'Collection de dette',
        message = 'Cher(e) %{value}. %{value2}, <br /><br />L\'Agence Centrale de Collection judiciaire (ACCJ) à facturé les amendes que vous avez reçu de la statetrooper.<br />Il y à <strong>$%{value3}</strong> qui ont été retiré de votre compte.<br /><br />Cordialement,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Poser une herse (statetrooper Only)',
        license_grant = 'Donner un Permis a quelqu\'un',
        license_revoke = 'Révoqué un Permis',
        place_object = 'Placer/Supprimer un objet (statetrooper Only)',
        cuff_player = 'Menotter un joueur (statetrooper Only)',
        escort = 'Escorter un joueur',
        callsign = 'Donner vous un matricule',
        clear_casign = 'Nettoyer les douilles de la zone (statetrooper Only)',
        jail_player = 'Mettre un joueur un prison (statetrooper Only)',
        unjail_player = 'Sortir un joueur de prison (statetrooper Only)',
        clearblood = 'Nettoie la zone du sang (statetrooper Only)',
        seizecash = 'Saisir du Cash (statetrooper Only)',
        softcuff = 'Menotter calmement (statetrooper Only)',
        camera = 'Voir les caméras de sécurité (statetrooper Only)',
        flagplate = 'Signaler une plaque (statetrooper Only)',
        unflagplate = 'Retirer un signalement de plaque (statetrooper Only)',
        plateinfo = 'Verifier une plaque (statetrooper Only)',
        depot = 'Mettre en fourrière avec un prix (statetrooper Only)',
        impound = 'Mettre en fourrière (statetrooper Only)',
        paytow = 'Payer le dépanneur (statetrooper Only)',
        paylawyer = 'Payer l\'avocat (statetrooper, Judge Only)',
        anklet = 'Attacher un bracelet éléctronique (statetrooper Only)',
        ankletlocation = 'Recevoir la position d\'un bracelet éléctronique',
        removeanklet = 'Retirer un bracelet éléctronique (statetrooper Only)',
        drivinglicense = 'Saisir le permis de conduire (statetrooper Only)',
        takedna = 'Prendre un échantillon ADN de quelqu\'un (Sac de preuve vide requis) (statetrooper Only)',
        statetrooper_report = 'Rapport de statetrooper',
